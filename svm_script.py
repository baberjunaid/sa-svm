...
print(chk_prob('Booooot maza aya hai'))
print(chk_prob('product kharab nikli hai'))
print(chk_prob('bohat khoob kya baat hai'))
print(chk_prob('maza aa gaya'))
print(chk_prob('yeah product bs shi hai'))
print(chk_prob('IS MOBILE KA GUZARA HAI'))
